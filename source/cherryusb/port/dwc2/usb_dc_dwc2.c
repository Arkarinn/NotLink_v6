...
int usb_dc_init(uint8_t busid)
{
    ...
    ulog_debug("========== dwc2 dcd params ==========");
    ulog_debug("CID:%08x", (unsigned int)USB_OTG_GLB->CID);
    ulog_debug("GSNPSID:%08x", (unsigned int)USB_OTG_GLB->GSNPSID);
    ulog_debug("GHWCFG1:%08x", (unsigned int)USB_OTG_GLB->GHWCFG1);
    ulog_debug("GHWCFG2:%08x", (unsigned int)USB_OTG_GLB->GHWCFG2);
    ulog_debug("GHWCFG3:%08x", (unsigned int)USB_OTG_GLB->GHWCFG3);
    ulog_debug("GHWCFG4:%08x", (unsigned int)USB_OTG_GLB->GHWCFG4);
...
void usbd_irq_handler(uint8_t busid)
{
